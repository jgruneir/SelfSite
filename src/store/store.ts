    ...
    state:{
        ...
        workExperience: [
            {title: "Software Engineer", dates: "July 2019 - Present", details: [
                "Supported a high-profile healthcare claims processing system by developing in Java, enhancing functionality of a system that handles millions of claims per day through features that would allow for more information to be processed, enhancing the speed of approval and denial through us",
            ...
            {title: "Associate Software Engineer", dates: "June 2018 - June 2019", details: [
                "Developed a proof of concept web application using React and Node.js to enable implementation managers to test health care policies in production, enabling a huge reduction in go-live-date issues with some of our biggest clients",
            ...
            {title: "Software Engineering Intern", dates: "June 2016 - August 2016", details: [
                "Developed in AngularJS on the front-end portal of a legacy contract management application to improve the user experience of the system",
                "Learned how to work in an Agile environment with a group of other interns, including acting as both developer and scrum master at various points"
            ]},
        ]
    }
});